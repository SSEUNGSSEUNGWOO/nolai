...
/**
 * 그림도 숫자야·칸이 많을수록 또렷해 -- 그림을 이루는 칸(픽셀).
 *
...
/**
 * AI는 글을 조각으로 읽어 -- 글 조각(토큰).
 *
 * 조각과 번호는 다른 레슨이 쓰는 것과 **같은 모델의 토크나이저**에서 나온다.
