...
export const metadata: Metadata = {
  ...
  title: "AI쏙 — AI는 어떻게 생각할까?",
  description:
    "만지면서 이해하는 AI. 10~13세 어린이가 AI의 작동 원리를 손으로 만져서 배우는 온라인 놀이터.",
  // 카톡·메신저에 링크를 붙였을 때의 미리보기. 이미지는 app/opengraph-image.png.
  openGraph: { type: "website", siteName: "AI쏙", locale: "ko_KR" },
  ...
  appleWebApp: { capable: true, statusBarStyle: "default", title: "AI쏙" },
};
...
FIRST VIEWPORT: 상단 바(AI쏙 · 부모·선생님께 · 시작하기). 데스크톱은 헤드라인 줄(좌 h1, 우 노리+말풍선) 아래에 실제 EmbeddingMap을 전폭(최대 5xl, 살짝 기울임)으로 — 지도가 4:3이라 옆에 두면 접힘 안에 못 들어와 위아래로 쌓았다. 모바일은 헤드라인 → 말풍선 → 지도. 첫 칩이 맥동하고 지도 안 "여기에 놓아봐"가 크게. 놓은 단어 수가 노리 대사·포즈를 바꾸고, 4개째에 색종이가 터지며 다음 섹션 제목에 그 수가 박힌다(시그니처 상호작용).
