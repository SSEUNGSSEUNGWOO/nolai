    ...
    <main className="mx-auto flex min-h-screen max-w-md flex-col gap-6 px-5 py-8 text-sm leading-relaxed lg:max-w-2xl">
      ...
      <Section title="2. 자동으로 생기는 정보">
        <ul className="list-disc pl-5">
          ...
          <li><strong>브라우저 저장소</strong> — <code>nolai:progress</code>(진도), <code>nolai:pending</code>(아직 서버에 저장하지 못한 레슨 완료와 작품), <code>nolai:muted</code>(음소거 설정). 내 방을 만들거나 들어갈 때 완료한 레슨 목록과 저장하지 못한 작품만 서버로 옮기고, 그 외에는 기기 밖으로 나가지 않습니다. 저장하지 못한 작품은 연결이 되면 내 방으로 보내고 기기에서 지웁니다. 나가기·방 삭제 때 기기의 진도도 함께 지웁니다.</li>
        </ul>
        <p>
